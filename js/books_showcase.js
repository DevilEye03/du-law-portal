...
(function () {
  ...
  const SEMESTER_SUBJECT_BOOKS = {
    ...
    2: [
      ...
      },
      {
        ...
        code: "LB-204",
        title: "Property Law",
        author: "LB-204 • Make Law Easy",
        year: "2025–26",
        stars: 5,
        unitsCount: "12 Comprehensive Units",
        casesCount: "22 Landmark Cases",
        desc: "Transfer of Property Act 1882: Movable & Immovable, Attestation, Notice, Spes Successionis, Perpetuities, Lis Pendens, Mortgages, Leases & Gifts.",
        spineBg: "#1c3d2e",
        spineInk: "#b7f4d8",
        spineFont: "700 38px Georgia",
        backBg: "#0f231a",
        ...
        edge: "#d8eee4",
        chapters: [
          "Movable & Immovable Property (Sec. 3 TPA)",
          "Attestation (Sec. 3 TPA)",
          "Notice (Actual, Constructive & Agent, Sec. 3 TPA)",
          "Meaning of Transfer of Property (Sec. 5 TPA)",
          "Spes Successionis & Feeding Grant by Estoppel (Sec. 6(a) & 43)",
          "Conditional Transfer & Restraints on Alienation (Sec. 10, 11, 40)",
          "Transfer to Unborn Persons & Perpetuities (Sec. 13–18)",
          "Vested & Contingent Interests (Sec. 19 & 21)",
          "Transfer Pending Litigation — Lis Pendens (Sec. 52)",
          "Mortgages & Charges (Sec. 58–60, 100)",
          "Lease and Licence (Sec. 105, 106 & Easements)",
          "Law of Gifts (Sec. 122–126)"
        ]
      },
      {
        id: "pil",
        ...
        author: "LB-205 • Make Law Easy",
        year: "2025–26",
        stars: 5,
        unitsCount: "7 Comprehensive Units",
        casesCount: "67 Landmark Cases",
        desc: "Nature & Sources of International Law, Treaties, State Responsibility, Law of the Sea (UNCLOS), Jurisdiction, Extradition & Sovereign Immunities.",
        spineBg: "#0f3659",
        spineInk: "#bae6fd",
        spineFont: "700 36px Georgia",
        backBg: "#082035",
        ...
        edge: "#dbeafe",
        chapters: [
          "Nature & Development of International Law",
          "Sources of International Law (Treaties, Custom, General Principles)",
          "Relationship Between International Law & Municipal Law",
          "State Responsibility (Attribution, Breach & Reparation)",
          "Law of the Sea (UNCLOS, Maritime Zones & Continental Shelf)",
          "State Jurisdiction & Extradition",
          "Sovereign, Diplomatic & Consular Immunity"
        ]
      },
      {
        id: "crimes2",
  ...
  function paintLawFront(x, w, h, o) {
    ...
    drawSpaced(x, 'MAKE LAW EASY • ACADEMIC SERIES', w / 2, 330, 4);
  ...
  function makeIndexPageTex(chapters) {
    ...
    x.fillText('Make Law Easy • Core Units Index', w / 2, 260);
  ...
  function openBook(book) {
    ...
    if (detailPanel) {
      if (codeBadge) codeBadge.textContent = book.cfg.code || 'LAW';
